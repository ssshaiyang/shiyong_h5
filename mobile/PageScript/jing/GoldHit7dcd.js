...
$(function () {
    ...
    lingaSort.order = globle.getUrlParam("order") || sortY || 7;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.Data.length; i++) {
                    ...
                    data.Data[i].goldStyle = "width:" + (data.Data[i].sk_gold_applyCount*100 / data.Data[i].sk_replace_count).toFixed(0) + "%";
                    data.Data[i].goldText = data.Data[i].sk_gold_applyCount == data.Data[i].sk_replace_count ? "已兑完" : "兑换";
                    data.Data[i].goldClass = data.Data[i].sk_gold_applyCount == data.Data[i].sk_replace_count ? "gray" : "tod";
    ...
    function getDetail(id) {
        ...
        $.post("/Jing/JinpDetail", { id: id }, function (data) {
            ...
            vmDetail.$data.sk_replace_count = data.Data.sk_replace_count - data.Data.sk_gold_applyCount;  //金币兑换剩余份数
            ...
            if (data.Data.sk_is_BlockLottery) {   //参团
                ...
                if (data.Data.sk_lottery_mode == 0 && (data.Data.sk_activity_type == 2 && compareTime(addDate(data.Data.sk_begindate, 2), getNowFormatDate()) || data.Data.sk_activity_type == 3 && compareTime(addDate(data.Data.sk_begindate, 3), getNowFormatDate()))) {
                    ...
                    goldText = "金币兑换" + "<br />" + data.Data.sk_replace_price + "金币";
                ...
                if (data.Data.hour >= 21) {
                    $("#applyText").attr("class", "get-apply gray");
                    $("#applyText").html("今日已结束");
                ...
                $(".get-invite").attr("data-momey", data.Data.sk_replace_price);
                if (data.Data.isSubmit) {
                    $("#applyText").attr("href", '/JpinShopIssue/OrderFlow?activityId=' + id); ///JpinShopIssue/OrderFlow?activityId=' + id + "&limited=1
                } else {
